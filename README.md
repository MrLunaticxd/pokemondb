# PokemonDB
This is a simplitic web-app that fetches data from an API(https://pokeapi.co/api/v2/pokemon) and outputs the data as a stylish list of pokemon names with pagination. 
